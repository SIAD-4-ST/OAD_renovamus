...
| `js/calcul.js` | Accesseurs et helpers sur les données parcellaires/exploitation : `getEx()`, `getRI()`, `pv()`, `getFdDist()`, palette `iColor()` |
...
| `calcIndice` | `I ∈ [0, 100]` ; chaque sous-score ∈ [0, 100] ; `I = 0` si toutes les pondérations sont nulles ; monotonicité manquants — 7 jeux de paramètres |
